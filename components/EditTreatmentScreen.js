    ...
    if (this.isNew) {
      ...
      <LinearGradient 
        ...
        <TouchableOpacity style={styles.mainButton} onPress={this.onSubmit} disabled={!this.state.dirty}>
          <Text style={[styles.mainButtonText, {color: this.state.dirty ? 'black' : 'grey'}]}>Create Treatment</Text>
        </TouchableOpacity>
      </LinearGradient>
    } else {
      saveBtn =
      (<LinearGradient 
        ...
        <TouchableOpacity style={styles.mainButton} onPress={this.onSubmit} disabled={!this.state.dirty}>
          <Text style={[styles.mainButtonText, {color: this.state.dirty ? 'black' : 'grey'}]}>Save Treatment</Text>
        </TouchableOpacity>
      </LinearGradient>);
      deleteBtn = 
